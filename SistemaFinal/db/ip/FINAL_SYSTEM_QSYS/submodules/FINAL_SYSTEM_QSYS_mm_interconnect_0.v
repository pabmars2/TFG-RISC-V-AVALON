// FINAL_SYSTEM_QSYS_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module FINAL_SYSTEM_QSYS_mm_interconnect_0 (
	...
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // RISC_V_AVALON_0_debug_translator:uav_waitrequest -> AvalonMasterUART_0_avalon_master_translator:uav_waitrequest
	wire  [31:0] avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_readdata;      // RISC_V_AVALON_0_debug_translator:uav_readdata -> AvalonMasterUART_0_avalon_master_translator:uav_readdata
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // AvalonMasterUART_0_avalon_master_translator:uav_debugaccess -> RISC_V_AVALON_0_debug_translator:uav_debugaccess
	wire  [31:0] avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_address;       // AvalonMasterUART_0_avalon_master_translator:uav_address -> RISC_V_AVALON_0_debug_translator:uav_address
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_read;          // AvalonMasterUART_0_avalon_master_translator:uav_read -> RISC_V_AVALON_0_debug_translator:uav_read
	wire   [3:0] avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // AvalonMasterUART_0_avalon_master_translator:uav_byteenable -> RISC_V_AVALON_0_debug_translator:uav_byteenable
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // RISC_V_AVALON_0_debug_translator:uav_readdatavalid -> AvalonMasterUART_0_avalon_master_translator:uav_readdatavalid
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_lock;          // AvalonMasterUART_0_avalon_master_translator:uav_lock -> RISC_V_AVALON_0_debug_translator:uav_lock
	wire         avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_write;         // AvalonMasterUART_0_avalon_master_translator:uav_write -> RISC_V_AVALON_0_debug_translator:uav_write
	wire  [31:0] avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_writedata;     // AvalonMasterUART_0_avalon_master_translator:uav_writedata -> RISC_V_AVALON_0_debug_translator:uav_writedata
	wire   [2:0] avalonmasteruart_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // AvalonMasterUART_0_avalon_master_translator:uav_burstcount -> RISC_V_AVALON_0_debug_translator:uav_burstcount
