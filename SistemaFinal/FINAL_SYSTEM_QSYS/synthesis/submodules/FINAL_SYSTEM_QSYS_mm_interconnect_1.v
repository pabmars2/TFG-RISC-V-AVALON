// FINAL_SYSTEM_QSYS_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module FINAL_SYSTEM_QSYS_mm_interconnect_1 (
		...
		output wire [5:0]  EXTERNAL_MEM_s1_address,                                      //                                        EXTERNAL_MEM_s1.address
		output wire        EXTERNAL_MEM_s1_write,                                        //                                                       .write
		input  wire [31:0] EXTERNAL_MEM_s1_readdata,                                     //                                                       .readdata
		output wire [31:0] EXTERNAL_MEM_s1_writedata,                                    //                                                       .writedata
		output wire [3:0]  EXTERNAL_MEM_s1_byteenable,                                   //                                                       .byteenable
		output wire        EXTERNAL_MEM_s1_chipselect,                                   //                                                       .chipselect
		output wire        EXTERNAL_MEM_s1_clken                                         //                                                       .clken
	);
	...
	wire   [31:0] external_mem_s1_agent_m0_readdata;                                                  // EXTERNAL_MEM_s1_translator:uav_readdata -> EXTERNAL_MEM_s1_agent:m0_readdata
	wire          external_mem_s1_agent_m0_waitrequest;                                               // EXTERNAL_MEM_s1_translator:uav_waitrequest -> EXTERNAL_MEM_s1_agent:m0_waitrequest
	wire          external_mem_s1_agent_m0_debugaccess;                                               // EXTERNAL_MEM_s1_agent:m0_debugaccess -> EXTERNAL_MEM_s1_translator:uav_debugaccess
	wire   [31:0] external_mem_s1_agent_m0_address;                                                   // EXTERNAL_MEM_s1_agent:m0_address -> EXTERNAL_MEM_s1_translator:uav_address
	wire    [3:0] external_mem_s1_agent_m0_byteenable;                                                // EXTERNAL_MEM_s1_agent:m0_byteenable -> EXTERNAL_MEM_s1_translator:uav_byteenable
	wire          external_mem_s1_agent_m0_read;                                                      // EXTERNAL_MEM_s1_agent:m0_read -> EXTERNAL_MEM_s1_translator:uav_read
	wire          external_mem_s1_agent_m0_readdatavalid;                                             // EXTERNAL_MEM_s1_translator:uav_readdatavalid -> EXTERNAL_MEM_s1_agent:m0_readdatavalid
	wire          external_mem_s1_agent_m0_lock;                                                      // EXTERNAL_MEM_s1_agent:m0_lock -> EXTERNAL_MEM_s1_translator:uav_lock
	wire   [31:0] external_mem_s1_agent_m0_writedata;                                                 // EXTERNAL_MEM_s1_agent:m0_writedata -> EXTERNAL_MEM_s1_translator:uav_writedata
	wire          external_mem_s1_agent_m0_write;                                                     // EXTERNAL_MEM_s1_agent:m0_write -> EXTERNAL_MEM_s1_translator:uav_write
	wire    [2:0] external_mem_s1_agent_m0_burstcount;                                                // EXTERNAL_MEM_s1_agent:m0_burstcount -> EXTERNAL_MEM_s1_translator:uav_burstcount
	wire          external_mem_s1_agent_rf_source_valid;                                              // EXTERNAL_MEM_s1_agent:rf_source_valid -> EXTERNAL_MEM_s1_agent_rsp_fifo:in_valid
	wire  [102:0] external_mem_s1_agent_rf_source_data;                                               // EXTERNAL_MEM_s1_agent:rf_source_data -> EXTERNAL_MEM_s1_agent_rsp_fifo:in_data
	wire          external_mem_s1_agent_rf_source_ready;                                              // EXTERNAL_MEM_s1_agent_rsp_fifo:in_ready -> EXTERNAL_MEM_s1_agent:rf_source_ready
	wire          external_mem_s1_agent_rf_source_startofpacket;                                      // EXTERNAL_MEM_s1_agent:rf_source_startofpacket -> EXTERNAL_MEM_s1_agent_rsp_fifo:in_startofpacket
	wire          external_mem_s1_agent_rf_source_endofpacket;                                        // EXTERNAL_MEM_s1_agent:rf_source_endofpacket -> EXTERNAL_MEM_s1_agent_rsp_fifo:in_endofpacket
	wire          external_mem_s1_agent_rsp_fifo_out_valid;                                           // EXTERNAL_MEM_s1_agent_rsp_fifo:out_valid -> EXTERNAL_MEM_s1_agent:rf_sink_valid
	wire  [102:0] external_mem_s1_agent_rsp_fifo_out_data;                                            // EXTERNAL_MEM_s1_agent_rsp_fifo:out_data -> EXTERNAL_MEM_s1_agent:rf_sink_data
	wire          external_mem_s1_agent_rsp_fifo_out_ready;                                           // EXTERNAL_MEM_s1_agent:rf_sink_ready -> EXTERNAL_MEM_s1_agent_rsp_fifo:out_ready
	wire          external_mem_s1_agent_rsp_fifo_out_startofpacket;                                   // EXTERNAL_MEM_s1_agent_rsp_fifo:out_startofpacket -> EXTERNAL_MEM_s1_agent:rf_sink_startofpacket
	wire          external_mem_s1_agent_rsp_fifo_out_endofpacket;                                     // EXTERNAL_MEM_s1_agent_rsp_fifo:out_endofpacket -> EXTERNAL_MEM_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> EXTERNAL_MEM_s1_agent:cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> EXTERNAL_MEM_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // EXTERNAL_MEM_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> EXTERNAL_MEM_s1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> EXTERNAL_MEM_s1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> EXTERNAL_MEM_s1_agent:cp_endofpacket
	...
	wire          external_mem_s1_agent_rp_valid;                                                     // EXTERNAL_MEM_s1_agent:rp_valid -> router_002:sink_valid
	wire  [101:0] external_mem_s1_agent_rp_data;                                                      // EXTERNAL_MEM_s1_agent:rp_data -> router_002:sink_data
	wire          external_mem_s1_agent_rp_ready;                                                     // router_002:sink_ready -> EXTERNAL_MEM_s1_agent:rp_ready
	wire          external_mem_s1_agent_rp_startofpacket;                                             // EXTERNAL_MEM_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          external_mem_s1_agent_rp_endofpacket;                                               // EXTERNAL_MEM_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          external_mem_s1_agent_rdata_fifo_src_valid;                                         // EXTERNAL_MEM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] external_mem_s1_agent_rdata_fifo_src_data;                                          // EXTERNAL_MEM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          external_mem_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_001:in_0_ready -> EXTERNAL_MEM_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> EXTERNAL_MEM_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> EXTERNAL_MEM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // EXTERNAL_MEM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> EXTERNAL_MEM_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) external_mem_s1_translator (
		.clk                    (clk_0_clk_clk),                                          //                      clk.clk
		.reset                  (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (external_mem_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (external_mem_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (external_mem_s1_agent_m0_read),                          //                         .read
		.uav_write              (external_mem_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (external_mem_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (external_mem_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (external_mem_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (external_mem_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (external_mem_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (external_mem_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (external_mem_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (EXTERNAL_MEM_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (EXTERNAL_MEM_s1_write),                                  //                         .write
		.av_readdata            (EXTERNAL_MEM_s1_readdata),                               //                         .readdata
		.av_writedata           (EXTERNAL_MEM_s1_writedata),                              //                         .writedata
		.av_byteenable          (EXTERNAL_MEM_s1_byteenable),                             //                         .byteenable
		.av_chipselect          (EXTERNAL_MEM_s1_chipselect),                             //                         .chipselect
		.av_clken               (EXTERNAL_MEM_s1_clken),                                  //                         .clken
		.av_read                (),                                                       //              (terminated)
		.av_begintransfer       (),                                                       //              (terminated)
		.av_beginbursttransfer  (),                                                       //              (terminated)
		.av_burstcount          (),                                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) external_mem_s1_agent (
		.clk                     (clk_0_clk_clk),                                          //             clk.clk
		.reset                   (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (external_mem_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (external_mem_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (external_mem_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (external_mem_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (external_mem_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (external_mem_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (external_mem_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (external_mem_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (external_mem_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (external_mem_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (external_mem_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (external_mem_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (external_mem_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (external_mem_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (external_mem_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (external_mem_s1_agent_rp_startofpacket),                 //                .startofpacket
		...
		.rf_sink_ready           (external_mem_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (external_mem_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (external_mem_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (external_mem_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (external_mem_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (external_mem_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (external_mem_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (external_mem_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (external_mem_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (external_mem_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                      // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                      //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                       //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                      //                .error
		.rdata_fifo_src_ready    (external_mem_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (external_mem_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (external_mem_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                                  //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                    //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) external_mem_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                          //       clk.clk
		.reset             (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (external_mem_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (external_mem_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (external_mem_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (external_mem_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (external_mem_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (external_mem_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (external_mem_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (external_mem_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (external_mem_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (external_mem_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_router router (
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_router_001 router_001 (
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_router_001 router_002 (
		.sink_ready         (external_mem_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (external_mem_s1_agent_rp_valid),                         //          .valid
		.sink_data          (external_mem_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (external_mem_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (external_mem_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                          //       clk.clk
		.reset              (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //       clk.clk
		.reset              (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                          //       clk.clk
		.reset               (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                          //       clk.clk
		.reset               (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                          //       clk.clk
		.reset              (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                          //       clk.clk
		.reset              (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                          //       clk.clk
		.reset               (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	FINAL_SYSTEM_QSYS_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                          // in_clk_0.clk
		.in_rst_0_reset (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (external_mem_s1_agent_rdata_fifo_src_data),              //     in_0.data
		.in_0_valid     (external_mem_s1_agent_rdata_fifo_src_valid),             //         .valid
		.in_0_ready     (external_mem_s1_agent_rdata_fifo_src_ready),             //         .ready
